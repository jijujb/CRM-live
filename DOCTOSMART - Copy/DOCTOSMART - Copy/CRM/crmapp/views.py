...
#             return  render(request,'registration.html',{'key':'password does not match'})
#         x=logins.objects(name1=NAME,email=EMAIL,password=PASSWORD,CONFIRMPASSWORD=confirmpassword)
